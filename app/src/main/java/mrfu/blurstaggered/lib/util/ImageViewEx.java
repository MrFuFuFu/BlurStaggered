...
public class ImageViewEx extends ImageView {
	...
	ImageLoader.AbsHttpCallback mHttpCallback = new ImageLoader.AbsHttpCallback() {
		
		@Override
		public void onSuccess(final ImageLoader.ImageRequest request, final Bitmap bitmap) {
		...
		@Override
		public void onFailure(ImageLoader.ImageRequest request, ImageLoader.HttpErrorResult error) {
