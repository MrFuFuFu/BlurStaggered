...
import mrfu.blurstaggered.lib.view.StaggeredGridView.OnScrollListener;
...
//    	}
    	...
    	if(header != null){
        	...
        	progressBar = (ProgressBarCircularIndeterminate)header.findViewById(R.id.progress_circular);
    	}
