...
import com.mrfu.blurview.util.ImageBlurLoader;
import com.mrfu.blurview.util.ImageBlurLoader.ThreadRequest;
import com.mrfu.blurview.util.ImageLoader;
...
import com.mrfu.blurview.util.ImageViewEx;
...
//			});
			...
			holder.relate_last.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
